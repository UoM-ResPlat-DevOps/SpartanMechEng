# SpartanIntro
An four hour training course for Mechanical Engineering that provides an introduction to the Spartan HPC/Cloud hybrid and an introduction to the Linux command line. Concentrates on OpenFOAM for examples.
...
`git clone --recursive https://github.com/UoM-ResPlat-DevOps/SpartanMechEng`

Or:

### take it step by step
`git clone https://github.com/UoM-ResPlat-DevOps/SpartanMechEng`
`git submodule init`
